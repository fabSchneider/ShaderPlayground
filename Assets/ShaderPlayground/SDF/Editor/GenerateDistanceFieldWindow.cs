...
namespace Fab.ShaderPlayground.Editor
{
	public class GenerateDistanceFieldWindow : EditorWindow
	{
		...
		[MenuItem("Tools/Generate/Distance Field")]
		...
		{
			var compute = AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/ShaderPlayground/SDF/JumpFloodDistance.compute");
			generator = new GenerateDistanceField(compute);
		}
