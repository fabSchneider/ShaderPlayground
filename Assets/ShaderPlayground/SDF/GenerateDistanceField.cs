...
namespace Fab.ShaderPlayground
{
	...
	{
		private static readonly string ComputeShaderResourcePath = "Compute/JumpFloodDistance";
		...
		public GenerateDistanceField(ComputeShader computeShader = null)
		{
			if (computeShader == null)
				compute = Resources.Load<ComputeShader>(ComputeShaderResourcePath);
			else
